...
export default function MorePages(){
    ...
    return(
        <div className="">
            ...
            <h2 className="text-center font-semibold">Select A House You Want To <a className="bg-green-400 px-3 py-1 text-white rounded-full">Sell</a></h2>
